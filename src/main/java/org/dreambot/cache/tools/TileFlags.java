...
public interface TileFlags {
    ...
    int WALL_BLOCK_NORTHWEST = WALL_BLOCK_WEST | WALL_BLOCK_NORTH;
    int WALL_BLOCK_NORTHEAST = WALL_BLOCK_EAST | WALL_BLOCK_NORTH;
    int WALL_BLOCK_SOUTHWEST = WALL_BLOCK_WEST | WALL_BLOCK_SOUTH;
    int WALL_BLOCK_SOUTHEAST = WALL_BLOCK_EAST | WALL_BLOCK_SOUTH;
    ...
    int UNLOADED = 0x1000000;
    int UNLOADED_ = 0xFFFFFF;
}
